...
def vote_mode_markup(_, current, mode: Union[bool, str] = None):
    return [
        [
            ...
            InlineKeyboardButton(text=_["ST_B_5"] if mode == True else _["ST_B_6"], callback_data="VOMODECHANGE"),
        ],
        [
            InlineKeyboardButton(text="-2", callback_data="FERRARIUDTI M"),
            InlineKeyboardButton(text=f"Cᴜʀʀᴇɴᴛ : {current}", callback_data="ANSWERVOMODE"),
...
def auth_users_markup(_, status: Union[bool, str] = None):
    return [
        [
            ...
            InlineKeyboardButton(text=_["ST_B_8"] if status == True else _["ST_B_9"], callback_data="AUTH"),
        ],
        [
...
def playmode_users_markup(_, Direct: Union[bool, str] = None, Group: Union[bool, str] = None, Playtype: Union[bool, str] = None):
    return [
        [
            InlineKeyboardButton(text=_["ST_B_10"], callback_data="SEARCHANSWER"),
            InlineKeyboardButton(text=_["ST_B_11"] if Direct == True else _["ST_B_12"], callback_data="MODECHANGE"),
        ],
        [
            InlineKeyboardButton(text=_["ST_B_13"], callback_data="AUTHANSWER"),
            InlineKeyboardButton(text=_["ST_B_8"] if Group == True else _["ST_B_9"], callback_data="CHANNELMODECHANGE"),
        ],
        [
            InlineKeyboardButton(text=_["ST_B_14"], callback_data="PLAYTYPEANSWER"),
            InlineKeyboardButton(text=_["ST_B_8"] if Playtype == True else _["ST_B_9"], callback_data="PLAYTYPECHANGE"),
        ],
        [
            InlineKeyboardButton(text=_["BACK_BUTTON"], callback_data="settings_helper"),
            InlineKeyboardButton(text=_["CLOSE_BUTTON"], callback_data="close"),
